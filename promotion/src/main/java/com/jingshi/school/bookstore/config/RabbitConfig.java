...
import com.jingshi.school.bookstore.util.DirectReceiver;
...
public class RabbitConfig {
    ...
    @Bean
    SimpleMessageListenerContainer processContainer(ConnectionFactory connectionFactory, DirectReceiver processReceiver) {
        SimpleMessageListenerContainer container = new SimpleMessageListenerContainer();
        container.setConnectionFactory(connectionFactory);
        container.setQueueNames("OrderDirectQueue"); // 监听delay_process_queue

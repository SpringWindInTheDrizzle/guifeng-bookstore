package com.jingshi.school.bookstore.commom;

public class Constants {
    //public final static String FILE_UPLOAD_DIC = "/opt/image/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    public final static String FILE_UPLOAD_DIC = "/Users/sky/codeLibrary/upload/";
    ...
    public final static int ORDER_SEARCH_PAGE_LIMIT = 50;//我的订单列表分页的默认条数(每页5条)
